...
var Game = new (function() {
  ...
  function startGame(puzzle) {
    ...
    myStartTime = startH * 3600 + startM * 60 + startS;
      ...
      myClock = setInterval(function() {
          ...
          minutaa = (Math.floor(myActualTime/60));
          sekundaa = (myActualTime%60);
          
          if (minutaa < 10) minutaa = "0" + minutaa;
          if (sekundaa < 10) sekundaa = "0" + sekundaa;
          
          
          var pokazDate = minutaa + ':' + sekundaa;
  ...
  function checkForLevelComplete() {
    ...
    if(sekundaa <= 30) {
        ...
        endFun((-0.025 * sekundaa + 1.75).toFixed(2));
    }
  }
