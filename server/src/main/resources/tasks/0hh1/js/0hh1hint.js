...
var HintType = {
  None: 'None',
  RowsMustBeUnique: 'Wiersze nie moga byc jednakowe.',
  ColsMustBeUnique: 'Kolumny nie moga byc jednakowe.',
  RowMustBeBalanced: 'Wiersze musza miec rowna ilosc kazdego koloru.',
  ColMustBeBalanced: 'Kolumny musza miec rowna ilosc kazdego koloru.',
  MaxTwoRed: 'Trzy sasiadujace czerwone kostki nie sa dopuszczalne.',
  MaxTwoBlue: 'Trzy sasiadujace niebieskie kostki nie sa dopuszczalne.',
  SinglePossibleRowCombo: 'Dostepna jest tylko jedna kombinacja.',
  SinglePossibleColCombo: 'Dostepna jest tylko jedna kombinacja.',
  Error: 'Ta kostka chyba nie pasuje tutaj.',
  Errors: 'Zastanow sie czy one sa dobrze ulozone.'
};
